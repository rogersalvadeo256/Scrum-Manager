...
public class DefinedSprintPOPOUP extends Stage {
	...
	private Button btnCancel, btnFinish,btnFinishSprint;
	...
	public DefinedSprintPOPOUP(PROJECT_TASK task, ScrumFrame f, PROJECT pj) {
		this.proj=pj;
		init();
	...
	private void init() {
		...
		hToggle = new HBox();
		hToggle.getChildren().addAll(btnFinishSprint, t1, t3, t5, t8);
		...
		btnFinishSprint = new Button("Terminar Sprint");
		btnFinishSprint.setOnAction(e->{
			// kskvmksmvsdkvmksdmfkvmkfdmvkmdfkmvkdfkvmkdfmvkmdfkvmdfkvmkdfmkvmkdfmvkmkfvdmkdf
			//,v,fl,dlv,df,vl,dfsvmsdkivksdmvfkmksdmvkmndsjvnjdsnvfjndjfvnjdnfvjnjdsfnv
			//mdkmvfbkdmfbkvmdfmbkmdfkbmkdfmbkmdfkmbkmdskfbmkdsmfkbmkdsfmbkmdsfkbmkm
		});
